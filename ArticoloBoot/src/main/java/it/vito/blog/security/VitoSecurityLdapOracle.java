...
public class VitoSecurityLdapOracle  extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	http
            .authorizeRequests()
                .antMatchers("/messaggiErrore","/items","/","/items/partialsListItem","/items/login","/items/partialsViewSlideShowItem","/items/partialsViewItem","/rest/items","/rest/items/*").permitAll()
